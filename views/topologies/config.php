        ...
        <div class="col-md-12">
            <form>
                <table class="table table-responsive table-condensed table-stripped">
                    ...
                    <tr ng-repeat="topology in form.topologies">
                        <td>
                            <input type="text" ng-model="topology.label" class="form-control">
                        </td>
                        <td>
                            <input type="number" ng-model="topology.sort" class="form-control">
                        </td>
                        <td class="text-right">
